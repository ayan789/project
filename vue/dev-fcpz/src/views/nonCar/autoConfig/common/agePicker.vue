<template>
  <div>
    <van-field
      readonly
      clickable
      :value="insuredAgesInfo.insuredAgesTypeVal"
      placeholder="请选择"
      @click="insuredAgesInfo.insuredAgesPicker = true"
      input-align="right"
    >
      <div slot="label">
    ...
    <van-popup v-model="insuredAgesInfo.insuredAgesPicker" position="bottom">
      <van-picker
        show-toolbar

  ...
  <div class="insuranceinfoConfirm">
    ...
    <div class="card">
      <van-cell-group>
        ...
        <van-cell
          title="证件号码"
          :value="f.appliIdentifyNumber"
        />
        <van-cell
          title="出生日期"
          :value="f.appliBirthDate"
        />
        <van-cell
          title="手机号"
          :value="f.appliMobile"
    ...
    <div class="card">
      <van-cell-group>
        ...
        <van-cell
          title="证件号码"
          :value="f.insuredIdentifyNumber"
        />
        <van-cell
          title="出生日期"
          :value="f.insuredBirthDate"
        />

        <van-cell
          title="手机号"
          :value="f.insuredMobile"
        />
    ...
    <div
      class="card"
      v-if="f.invoiceInfo.companyName!=''"
    >
      <van-cell-group>
        <van-cell
          title="开票信息"
        ...
        <van-cell
          title="发票类型"
          :value="f.invoiceInfo.invoiceType =='3'? '增值税电子发票' : '增值税普通发票'"
        />
        <van-cell
          title="发票抬头"
          :value="f.invoiceInfo.companyName"
        />
        <van-cell
          title="手机号"
...
export default {
  ...
  methods: {
    ...
    enter () {
      ...
      if (localStorage.getItem("newDataOrderNo")) {
          ...
          if (res.code == "1") {
            ...
            this.$router.push({
              ...
              query: {
                ...
                sumPremium: this.newData.sumPremium,
                mobile: this.newData.appliMobile,
                productName: this.newData.formulaName,
                applicantName: this.newData.appliName,
                insuredName: this.newData.insuredName,
                insuredMobile: this.newData.insuredMobile,
                invoiceType: this.newData.invoiceInfo.invoiceType,
                isFlag: 'N',
                productCode: this.newData.productCode
        ...
        placeOrder(this.newData).then(res => {
          Toast.clear;
          if (res.code == "1") {
            this.$router.push({
              name: "signatureConfirm",
  ...
  computed: {
    // formatSumPremium() {
    //   return this.f.sumPremium.toFixed(2)

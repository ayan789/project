<!--
 * @Description: 非车配置 --- 订单详情--核保完成
 * @Date: 2020-06-17 13:41:52
 * @Author: zhangminjie
 * @LastEditTime: 2020-07-03 17:26:34
 * @FilePath: \nonCarCongfig\src\views\order\dynamicOrderDetail\underwriting.vue
-->
<template>
  <div class="underwriting" id="underwriting">
    <headerNav statusName="核保完成" @goBackEvent="goBack" />

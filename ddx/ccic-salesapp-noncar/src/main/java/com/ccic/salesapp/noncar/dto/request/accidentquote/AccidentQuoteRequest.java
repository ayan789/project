...
public class AccidentQuoteRequest extends RequestBody{
		//投保单号
		private String proposalNo;
		//原保单号 businessType为“4-续保”时，必填
		private String historyPolicyNo;
		//业务来源属性
		...
		//发票信息
		private List<com.ccic.salesapp.noncar.dto.request.noncar.InvoiceInfo> invoiceInfoList;
		//
...
//			private List<InsuredGroup> insuredGroupList;
	...
	public List<com.ccic.salesapp.noncar.dto.request.noncar.InvoiceInfo> getInvoiceInfoList() {
		return invoiceInfoList;
	}
	public void setInvoiceInfoList(List<com.ccic.salesapp.noncar.dto.request.noncar.InvoiceInfo> invoiceInfoList) {

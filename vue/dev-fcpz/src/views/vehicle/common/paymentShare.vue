 ...
 * @Last Modified time: 2020-04-22 11:55:45
 * @FilePath: /src/views/vehicle/common/paymentShare.vue
-->
<template>
  <div>
    <nav-bar type="vehicle" title="保单支付" :left="false" />
    <!-- 页面内容 -->
    <div class="content">
      <!--车辆-->
      <div class="card">
      ...
      <div class="bottom-info">
        <div class="business-plan-book" @click="pay">去支付</div>
      </div>
    </div>
  </div>
</template>

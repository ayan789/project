...
export default {
  ...
  data() {
    return {
      ...
      cardNames: [
        { id: 0, name: "身份证", isNeed: false },
        { id: 1, name: "行驶证", isNeed: false },
        { id: 2, name: "驾车照片", isNeed: false },
        { id: 3, name: "投保单", isNeed: false },
        { id: 4, name: "购车发票", isNeed: false },
        { id: 5, name: "合格证", isNeed: false },
        { id: 6, name: "验车照片", isNeed: false },
        { id: 7, name: "一般纳税人资质证明", isNeed: false },
        { id: 8, name: "关联交易合规审核文件", isNeed: false },
        { id: 9, name: "电子投保单", isNeed: false },
        { id: 10, name: "投保人照片", isNeed: false },
        { id: 11, name: "电子保单", isNeed: false },
        { id: 12, name: "电子批单", isNeed: false }
      ],
  ...
  created() {
    //TODO 未来通过接口获得params数据
    let params = decodeURIComponent(this.$GetRequest("params", true))
      ? JSON.parse(decodeURIComponent(this.$GetRequest("params", true)))
      : {};
    this.proposalNo = params.proposalNo
      ? params.proposalNo
      : this.$route.query.proposalNo;
    this.custNo = params.custNo
      ? params.custNo
      : localStorage.getItem("userCode");
    this.comCode = params.comCode
      ? params.comCode
      : JSON.parse(localStorage.getItem("userInfo")).comCode;
    this.queryh5imgQueryDownService();
    if (!this.$isNull(params) && !this.$isNull(params.token)) {

...
/**
 * <p>PerBaseInfoInquiryRequestDTO complex type�� Java �ࡣ
 * 
 * <p>����ģʽƬ��ָ�������ڴ����е�Ԥ�����ݡ�
 * 
 * <pre>
 * &lt;complexType name="PerBaseInfoInquiryRequestDTO"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "PerBaseInfoInquiryRequestDTO", propOrder = {
    "custNo",
    "role",
    "comCode"
})
public class PerBaseInfoInquiryRequestDTO {

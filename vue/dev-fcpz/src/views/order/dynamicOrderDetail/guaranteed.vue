<!--
 * @Description: 非车配置 --- 订单详情 --- 保障中
 * @Date: 2020-06-17 13:41:52
 * @Author: zhangminjie
 * @LastEditTime: 2020-07-03 17:26:16
 * @FilePath: \nonCarCongfig\src\views\order\dynamicOrderDetail\guaranteed.vue
-->
<template>
  <div class="guaranteed" id="guaranteed">
    <headerNav statusName="保障中" @goBackEvent="goBack" />
      ...
      getOrderDetail(obj)
        .then(res => {
          ...
          if (order) {
            ...
            this.invoiceFlag = invoiceFlag; //("0:无发票信息,1:个人，2：企业")

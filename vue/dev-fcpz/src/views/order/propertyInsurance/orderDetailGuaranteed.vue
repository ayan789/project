...
<template>
  <div class="orderDetailGuaranteed" id="orderDetailGuaranteed">
    <orderDetailNav statusName="保障中" @goBackEvent="goBack"></orderDetailNav>
...
export default {
  ...
  methods: {
    ...
    goBack() {
      this.$router.push({
        path: "/order/orderList/orderList?moudle=1&status=3"
      });
    },
    // 获取订单详情
    getOrderInfo() {

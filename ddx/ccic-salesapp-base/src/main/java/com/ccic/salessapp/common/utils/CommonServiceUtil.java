...
public class CommonServiceUtil {
	...
	public static RequestHead getConsumerID(){
	 ...
	 * @throws Exception 
	 */
	public static String postJsonRequest(String reqJson, String uri, String charset) throws Exception {
	...
	public static String postJsonRequest(String reqJson, String uri) throws Exception {

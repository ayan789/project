<!--
 * @Description: 非车配置---产品海报
 * @Date: 2020-05-21 14:31:05
 * @Author: zhangminjie
 * @LastEditTime: 2020-06-24 10:51:43
 * @FilePath: \nonCarCongfig\src\views\nonCar\autoConfig\prPoster.vue
-->
<template>
  <div class="prPoster" id="prPoster">
    ...
    >
      ...
      <div class="productPoster_buttom">
        <div v-for="(v, i) in tempIcon" :key="i">

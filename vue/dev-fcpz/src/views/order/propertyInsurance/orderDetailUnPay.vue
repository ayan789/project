<!--
 * @Description: 订单详情--待支付
 * @Date: 2020-03-11 14:25:45
 * @Author: zhagnminjie
 * @LastEditTime: 2020-05-15 13:49:15
 -->
<template>
  <div class="orderDetailUnPay" id="orderDetailUnPay">
    <orderDetailNav
      statusName="待支付"
      @goBackEvent="goBack"
      :status="orderStauts"
      :intervalDate="orderInfo.intervalDate"
    ></orderDetailNav>
...
import { EnBase64 } from "../../../utils/index.js";
Vue.use(Card);
export default {
  name: "orderDetailUnPay",
  components: {
    orderDetailMidContentNew,
    orderDetailStatementUnused,
    orderDetailTopUnusedAndGuaranteed,

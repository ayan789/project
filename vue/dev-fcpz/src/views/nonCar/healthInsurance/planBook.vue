...
export default {
  ...
  created () {
    ...
    this.name = this.millionInfo.appliName;
    this.businessName = this.millionInfo.businessName;
    if (!this.$isNull(this.millionInfo.agentInfo)) {
      this.agentInfo = JSON.parse(this.millionInfo.agentInfo);
    } else {
      this.agentInfo = null;
    }
  ...
  methods: {
    ...
    goMillionPlan () {
      if (!this.$isWeiXin) {
        ...
        if (this.$route.params.from == "prPlan") {
          this.$router.push({ name: "prPlanInfo" });
        } else {
          this.$router.push({ name: "millionInfo", query: this.millionInfo });

...
<template>
  <div id="super">
    <van-sticky>
      <nav-bar type="vehicle" title="支付宝短信支付" clear="1" @clickBack="$router.back()" />
    </van-sticky>
    <div class="content">
      <div id="topTitle">请选择接收短信手机号码</div>
      <div id="center">
        <div class="father">
          <van-checkbox v-model="checkedInsured" @change="v => changePhoneNum(v, 'insured')"></van-checkbox>
          <div class="subCenter">
        ...
        <div class="father">
          <van-checkbox v-model="checkedBeInsured" @change="v => changePhoneNum(v, 'beInsured')"></van-checkbox>
          <div class="subCenter">
        ...
        <div class="father last">
          <van-checkbox v-model="checkedMobile" @change="v => changePhoneNum(v, 'input')"></van-checkbox>
          <div class="subCenter">
            <div class="centerTitle">其他</div>
            <div class="centerDetail">手机号码</div>
          </div>
          <div class="rightText">
            <input type="text" placeholder="请输入" v-model="inputMobile" />
          </div>
        </div>
      </div>
      <div id="bottomMsg">

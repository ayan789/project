...
public class AESUtil {
    ...
    public static void main(String[] args) throws NoSuchAlgorithmException, IllegalBlockSizeException, BadPaddingException, NoSuchPaddingException, InvalidKeyException, UnsupportedEncodingException {
        String key="9CF181E2CD72F8E6";
        String content="y+5kbbCoRr/T9oAynULzZGUTFp4zWn9dIhIRCihNs8HrJ/jvHLwHchx4VgZXw0mA/V5nzSi48nzUFqqWuJdbjrAEL5yF5oWbYRoCnad6kr88yLDORnSkZvhDaBzkgV3v";

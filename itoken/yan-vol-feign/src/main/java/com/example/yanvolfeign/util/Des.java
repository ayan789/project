package com.example.yanvolfeign.util;

import com.alibaba.fastjson.JSONObject;
import com.example.yanvolfeign.BookDto;
import com.example.yanvolfeign.Insure;
...
public class Des {
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println(Des.encrypt("{\"offset\":0,\"limit\":10}", Charset.forName("utf8"), "testtest"));

...
import com.ccic.salesapp.noncar.service.CarApplicationFacade;
 ...
 */
@Slf4j
public class CarApplicationFacadeImpl extends AbstractFacade implements CarApplicationFacade {
	...
	/*public static void main(String[] args) {
		UnpayPolicyFacadeImpl unpayPolicyFacadeImpl = new UnpayPolicyFacadeImpl();
		unpayPolicyFacadeImpl.getUnpayPolicy();
	}*/

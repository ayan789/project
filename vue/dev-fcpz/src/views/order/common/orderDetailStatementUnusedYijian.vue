...
<template>
  <div class="statement">
    ...
    <p>
      ...
      <span @click="redirectTerms(2)">《投保人声明》</span>、
    ...
    <div v-if="insuranceType == 2">
      <div
        class="bottom"
        v-if="orderStauts == 7 || orderStauts == 10"
      >
        <button
          class="blue width100"
          @click="copyInsurance"
      ...
      >
        ...
        <button
          class="blue"
          v-if="orderStauts == 2 || orderStauts == 4"
    ...
    <div v-if="insuranceType == 1">
      ...
      >
        <button
          class="white"
          v-if="orderStauts == 0 || orderStauts == 2 || orderStauts == 4"
          @click="copyInsurance"
        >
          复制投保单
        </button>
...
<script>
export default {
  name: "orderDetailStatementUnusedYijian",
  props: {
  ...
  methods: {
    ...
    redirectTerms (type) {
      switch (type) {
        case 1: //投保须知
          this.$router.push({ name: "InsureNotice", params: { from: this.productCode } });
          break;

        case 2: //投保人声明
          this.$router.push({ name: "InsureStatement", params: { from: this.productCode } });
          break;

        case 3: //保险条款
          this.$router.push({ name: "personalTerms", params: { from: this.productCode } });
          break;
        case 4: //特别约定
          this.$router.push({ name: "Aboutpersonal", params: { from: this.productCode, isSheBao: this.isSheBao } });
          break;
      }
    },

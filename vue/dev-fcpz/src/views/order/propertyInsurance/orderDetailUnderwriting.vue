...
<template>
  <div class="orderDetailUnderwriting" id="orderDetailUnderwriting">
    <orderDetailNav
      statusName="核保完成"
      @goBackEvent="goBack"
    ></orderDetailNav>
...
import { applyPay, queryZc } from "@src/http/module/nonCar.js";
...
export default {
  ...
  methods: {
    ...
    immediatelyPay() {
      ...
      if (this.$isNull(this.orderInfo.payApplyNo)) {
        this.getApplyPay();
      } else {
        //跳转到支付页面
        this.$router.push({

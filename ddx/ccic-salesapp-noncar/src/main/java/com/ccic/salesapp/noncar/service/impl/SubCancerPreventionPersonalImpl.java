...
@Service
@Slf4j
public class SubCancerPreventionPersonalImpl implements SubCancerPreventionPersonal {
	...
	@Override
	public HttpResult subCancerPrevention(StoreOracleRequestVO requestVo) throws Exception {
		...
		if (null != storeFormulas) {
			...
			// 渠道产品代码
			channelOpInfo.setChannelProductCode("WTI01");// 产品代码
			// 渠道交易流水号
...
//			// 条款代码
//			coverage1.setClauseCode("CF1100707");
//			// 责任代码
//			coverage1.setKindCode("C100979");
			// 单位保费
...
//			// 条款代码
//			coverage2.setClauseCode("CF1100707");
//			// 责任代码
//			coverage2.setKindCode("C100979");
//			// 单位保费
//			// 应收保费/真实保费/RealPremium,=调整保费
...
//			// 条款代码
//			coverage3.setClauseCode("CF1100707");
//			// 责任代码
//			coverage3.setKindCode("C100979");
//			// 单位保费
//			// 应收保费/真实保费/RealPremium,=调整保费
...
//			// 条款代码
//			coverage4.setClauseCode("CF1100707");
//			// 责任代码
//			coverage4.setKindCode("C100979");
//			// 单位保费
//			// 应收保费/真实保费/RealPremium,=调整保费
...
//			// 条款代码
//			coverage5.setClauseCode("CF1100707");
//			// 责任代码
//			coverage5.setKindCode("C100979");
//			policyCoverageList1.add(coverage5);
//
//			// 责任信息6
//			PolicyCoverage coverage6 = new PolicyCoverage();
//			// 条款代码
//			coverage6.setClauseCode("CF1100707");
//			// 责任代码
//			coverage6.setKindCode("C100979");
				...
				if (!"0".equals(result.getCode())) {
					if (quotePriceResponseDTO != null) {
						if (quotePriceResponseDTO.getProposalNo() != null
							...
							storeInsureInfo.setInsuranceCode("WTI");// 险种代码
							storeInsureInfo.setInsuranceName("大地守护一生中老年防癌险");// 险种名称
							...
							/*
							 * if (requestVo.getaKZEXClause().equals("Y")) { additionalCode +=
							 * "_aKZEXClause"; } if (requestVo.getaEXTZClause().equals("Y")) {
							 * additionalCode += "_aEXTZClause"; } if
							 * (requestVo.getaEXYLClause().equals("Y")) { additionalCode += "_aEXYLClause";
							 * } if (requestVo.getaEXZZClause().equals("Y")) { additionalCode +=
							 * "_aEXZZClause"; }
							 */
					...
					log.info("##########大地守护一生中老年防癌险试算失败，未返回投保单号。############");
				}
			} catch (Exception e) {
				result.setCode("0");
